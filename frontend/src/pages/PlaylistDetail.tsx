...
export default function PlaylistDetail() {
  ...
  if (isLoading) return <div className="p-8 text-neutral-400">Cargando playlist...</div>;
  if (error || !playlist) return <div className="p-8 text-red-400">No se pudo cargar la playlist.</div>;
